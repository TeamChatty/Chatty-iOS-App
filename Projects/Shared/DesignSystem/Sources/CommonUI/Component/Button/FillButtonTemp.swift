...
/// 기존 FillButton 은 horizontalInset이 적용되어 있지 않아 임시로 작성했습니다.
open class FillButtonTemp: BaseControl, Touchable, Highlightable, Transformable {
  // MARK: - View Property
...
extension FillButtonTemp: StateConfigurable {
  public enum State {
    case enabled
    case disabled
  }
