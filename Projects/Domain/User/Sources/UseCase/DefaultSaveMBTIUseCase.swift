...
public final class DefaultSaveMBTIUseCase: SaveMBTIUseCase {
  ...
  public func execute(mbti: String) -> Single<Bool> {
    return userAPIRepository.saveMBTI(mbti: mbti)
