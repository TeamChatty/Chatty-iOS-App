//
//  DefaultSaveSchoolUseCase.swift
//  DomainUser
//
...
public final class DefaultSaveSchoolUseCase: SaveSchoolUseCase {
  ...
  public func execute(school: String) -> Single<Bool> {
    return userAPIRepository.saveSchool(school: school)
