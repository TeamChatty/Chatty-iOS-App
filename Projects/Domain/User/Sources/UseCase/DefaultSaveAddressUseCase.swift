//
//  DefaultSaveAddressUseCase.swift
//  DomainUserInterface
//
...
public final class DefaultSaveAddressUseCase: SaveAddressUseCase {
  ...
  public func execute(address: String) -> Single<Bool> {
    return userAPIRepository.saveAddress(address: address)
