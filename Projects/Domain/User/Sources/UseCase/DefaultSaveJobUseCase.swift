...
public final class DefaultSaveJobUseCase: SaveJobUseCase {
  ...
  public func execute(job: String) -> Single<Bool> {
    return userAPIRepository.saveJob(job: job)
